...
export const Hero: React.FC<HeroProps> = ({
  ...
  return (
    <div className="bg-gradient-to-b from-[#33180e] via-[#4d2618] to-[#251108] text-amber-50 border-b border-current/10 pt-8 pb-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-7 text-right">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-black/20 border border-current/10 text-xs font-bold mb-4">
              ...
              <span>👜 بوتيك الحقائب والجلديات الفاخرة</span>
            </div>

            <h1 className="text-2xl sm:text-4xl lg:text-5xl font-black leading-tight mb-4 tracking-tight">
              أفخم الحقائب الجلدية والأحذية النسائية الإيطالية
            </h1>

            <p className="text-sm sm:text-base opacity-90 mb-6 leading-relaxed max-w-2xl font-normal">
              حقائب يد، محافظ، وصنادل نسائية راقية مصممة من أجود الجلود الطبيعية لإطلالة مفعمة بالثقة - مرحباً بكم في <strong className="underline decoration-current/30">{storeConfig.companyNameAr}</strong>.
            </p>

            <div className="flex flex-wrap items-center gap-4">
              <a
                href="#products-grid"
                className="bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-stone-950 font-black shadow-lg shadow-orange-600/25 inline-flex items-center gap-2 px-6 py-3 rounded-xl text-sm transition transform active:scale-95"
              >
            ...
            <button
              ...
              className={`px-4 py-2 rounded-xl text-xs font-bold whitespace-nowrap transition-all ${
                selectedCategory === 'all'
                  ? ' bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-stone-950 font-black shadow-lg shadow-orange-600/25 '
