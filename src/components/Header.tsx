...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="sticky top-0 z-40 bg-[#33180e] text-amber-50 border-b border-[#4d2618] backdrop-blur-md shadow-lg">
      <div className="bg-gradient-to-r from-[#9a3412] via-[#c2410c] to-[#9a3412] text-white font-bold text-xs py-1.5 px-4">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3.5">
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            <button
              onClick={onOpenCart}
              className="relative flex items-center gap-2 bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-stone-950 font-black shadow-lg shadow-orange-600/25 px-4 py-2.5 rounded-xl transition transform active:scale-95"
            >
