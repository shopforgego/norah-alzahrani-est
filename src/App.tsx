        ...
        {filteredProducts.length === 0 ? (
          <div className="bg-black/5 border border-current/10 rounded-3xl p-12 text-center">
            ...
            <button
              ...
              className="bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-stone-950 font-black shadow-lg shadow-orange-600/25 text-xs px-4 py-2 rounded-xl"
            >
              إعادة تعيين البحث
            </button>
          </div>
